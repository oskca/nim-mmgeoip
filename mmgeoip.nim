...
var GeoIPDBFileName* {.importc: "GeoIPDBFileName".}: cstringArray

var GeoIPDBDescription* {.importc: "GeoIPDBDescription".}: array[
    NUM_DB_TYPES, cstring]

var GeoIP_custom_directory* {.importc: "GeoIP_custom_directory".}: cstring

##  Warning: do not use those arrays as doing so may break your
##  program with newer GeoIP versions

var GeoIP_country_code* {.importc: "GeoIP_country_code".}: array[256,
    array[3, char]]

var GeoIP_country_code3* {.importc: "GeoIP_country_code3".}: array[256,
    array[4, char]]

var GeoIP_country_name* {.importc: "GeoIP_country_name".}: array[256,
    cstring]

var GeoIP_utf8_country_name* {.importc: "GeoIP_utf8_country_name".}: array[
    256, cstring]

var GeoIP_country_continent* {.importc: "GeoIP_country_continent".}: array[
    256, array[3, char]]

proc GeoIP_setup_custom_directory*(dir: cstring) {.cdecl,
    importc: "GeoIP_setup_custom_directory".}

proc GeoIP_open_type*(`type`: cint; flags: cint): ptr GeoIPCtx {.cdecl,
    importc: "GeoIP_open_type".}

proc GeoIP_new*(flags: cint): ptr GeoIPCtx {.cdecl, importc: "GeoIP_new".}
...
proc country_name_by_id*(gi: ptr GeoIPCtx; id: cint): cstring {.cdecl,
    importc: "GeoIP_country_name_by_id".}
...
proc database_info*(gi: ptr GeoIPCtx): cstring {.cdecl,
    importc: "GeoIP_database_info".}

proc database_edition*(gi: ptr GeoIPCtx): cuchar {.cdecl,
    importc: "GeoIP_database_edition".}
